...
STORY.md §5 is the what; this is the how.

- **When.** `ft_world_naming_due` is true for the one update in which you
  finish a step with Wren behind you, no name yet, in the Approach (or
  Weldhome), with her off your tile and neither of you in the long grass.
