...
# LEDGER. An archive robot: a filing cabinet with a small worried head on
# top, round spectacles, and drawers down its front. Important, so tall —
# the head and the spectacles are what nobody else has.
SPRITES["ledger"] = """
.....######.....
....#......#....
....#.##.##.#...
...
# MA RIVET. Important, so tall: welding goggles pushed up on her forehead
# (the thing on the silhouette nobody else has), a mouth open mid-shout, and
# a work apron over shoulders built for hauling scrap.
SPRITES["rivet"] = """
....########....
...##..##..##...
...##..##..##...
...
# Echo in a fight: the same dark body at a foe's 16 rows — one row of the
# antenna and the blank row under the feet are what it gives up. It still
# has to read as you, side by side with you in the arena.
SPRITES["echo_foe"] = """
.......##.......
..############..
.##############.
...
# Status: your own face, because it is a page about you.
SPRITES["icon_orb"] = """
.......##.......
.......##.......
..############..
...
# Settings: a gear. Built from rules rather than drawn by hand, so it is the
# same under every rotation — the first one was wider than it was tall and
# read as a bug.
SPRITES["icon_gear"] = """
......####......
......####......
